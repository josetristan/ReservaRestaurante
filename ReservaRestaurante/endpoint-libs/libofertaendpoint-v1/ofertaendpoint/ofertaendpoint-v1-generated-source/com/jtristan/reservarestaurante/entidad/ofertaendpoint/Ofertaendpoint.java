...
package com.jtristan.reservarestaurante.entidad.ofertaendpoint;
...
public class Ofertaendpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class GetOferta extends OfertaendpointRequest<com.jtristan.reservarestaurante.entidad.ofertaendpoint.model.Oferta> {
    ...
    protected GetOferta(java.lang.String id) {
      super(Ofertaendpoint.this, "GET", REST_PATH, null, com.jtristan.reservarestaurante.entidad.ofertaendpoint.model.Oferta.class);
   ...
   *
   * This request holds the parameters needed by the the ofertaendpoint server.  After setting any
   * optional parameters, call the {@link GetRestaurante#execute()} method to invoke the remote
   * operation.
   *
   * @param id
   * @return the request
   */
  public GetRestaurante getRestaurante(java.lang.String id) throws java.io.IOException {
    GetRestaurante result = new GetRestaurante(id);
    initialize(result);
    return result;
  }

  public class GetRestaurante extends OfertaendpointRequest<com.jtristan.reservarestaurante.entidad.ofertaendpoint.model.Restaurante> {
     ...
     * @since 1.13
     */
    protected GetRestaurante(java.lang.String id) {
      super(Ofertaendpoint.this, "GET", REST_PATH, null, com.jtristan.reservarestaurante.entidad.ofertaendpoint.model.Restaurante.class);
      this.id = com.google.api.client.util.Preconditions.checkNotNull(id, "Required parameter id must be specified.");
    }
    ...
    public GetRestaurante setId(java.lang.String id) {
      this.id = id;
      return this;
    }
   ...
   * operation.
   *
   * @param content the {@link com.jtristan.reservarestaurante.entidad.ofertaendpoint.model.Oferta}
   * @return the request
   */
  public InsertOferta insertOferta(com.jtristan.reservarestaurante.entidad.ofertaendpoint.model.Oferta content) throws java.io.IOException {
    InsertOferta result = new InsertOferta(content);
    initialize(result);
    return result;
  }

  public class InsertOferta extends OfertaendpointRequest<com.jtristan.reservarestaurante.entidad.ofertaendpoint.model.Oferta> {
     ...
     * @since 1.13
     */
    protected InsertOferta(com.jtristan.reservarestaurante.entidad.ofertaendpoint.model.Oferta content) {
      super(Ofertaendpoint.this, "POST", REST_PATH, content, com.jtristan.reservarestaurante.entidad.ofertaendpoint.model.Oferta.class);
    }
  ...
  public class ListOferta extends OfertaendpointRequest<com.jtristan.reservarestaurante.entidad.ofertaendpoint.model.CollectionResponseOferta> {
    ...
    protected ListOferta() {
      super(Ofertaendpoint.this, "GET", REST_PATH, null, com.jtristan.reservarestaurante.entidad.ofertaendpoint.model.CollectionResponseOferta.class);
    }
   ...
   * @return the request
   */
  public UpdateOferta updateOferta(com.jtristan.reservarestaurante.entidad.ofertaendpoint.model.Oferta content) throws java.io.IOException {
    UpdateOferta result = new UpdateOferta(content);
    initialize(result);
    return result;
  }

  public class UpdateOferta extends OfertaendpointRequest<com.jtristan.reservarestaurante.entidad.ofertaendpoint.model.Oferta> {
     ...
     * @since 1.13
     */
    protected UpdateOferta(com.jtristan.reservarestaurante.entidad.ofertaendpoint.model.Oferta content) {
      super(Ofertaendpoint.this, "PUT", REST_PATH, content, com.jtristan.reservarestaurante.entidad.ofertaendpoint.model.Oferta.class);
    }
