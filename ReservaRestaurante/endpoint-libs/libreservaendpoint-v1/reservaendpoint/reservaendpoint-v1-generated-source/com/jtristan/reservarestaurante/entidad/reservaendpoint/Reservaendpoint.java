...
package com.jtristan.reservarestaurante.entidad.reservaendpoint;
...
public class Reservaendpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class GetReserva extends ReservaendpointRequest<com.jtristan.reservarestaurante.entidad.reservaendpoint.model.Reserva> {
    ...
    protected GetReserva(java.lang.Long id) {
      super(Reservaendpoint.this, "GET", REST_PATH, null, com.jtristan.reservarestaurante.entidad.reservaendpoint.model.Reserva.class);
   ...
   * operation.
   *
   * @param content the {@link com.jtristan.reservarestaurante.entidad.reservaendpoint.model.Reserva}
   * @return the request
   */
  public InsertReserva insertReserva(com.jtristan.reservarestaurante.entidad.reservaendpoint.model.Reserva content) throws java.io.IOException {
    InsertReserva result = new InsertReserva(content);
    initialize(result);
    return result;
  }

  public class InsertReserva extends ReservaendpointRequest<com.jtristan.reservarestaurante.entidad.reservaendpoint.model.Reserva> {
     ...
     * @since 1.13
     */
    protected InsertReserva(com.jtristan.reservarestaurante.entidad.reservaendpoint.model.Reserva content) {
      super(Reservaendpoint.this, "POST", REST_PATH, content, com.jtristan.reservarestaurante.entidad.reservaendpoint.model.Reserva.class);
    }
  ...
  public class ListReserva extends ReservaendpointRequest<com.jtristan.reservarestaurante.entidad.reservaendpoint.model.CollectionResponseReserva> {
    ...
    protected ListReserva() {
      super(Reservaendpoint.this, "GET", REST_PATH, null, com.jtristan.reservarestaurante.entidad.reservaendpoint.model.CollectionResponseReserva.class);
    }
   ...
   * @return the request
   */
  public UpdateReserva updateReserva(com.jtristan.reservarestaurante.entidad.reservaendpoint.model.Reserva content) throws java.io.IOException {
    UpdateReserva result = new UpdateReserva(content);
    initialize(result);
    return result;
  }

  public class UpdateReserva extends ReservaendpointRequest<com.jtristan.reservarestaurante.entidad.reservaendpoint.model.Reserva> {
     ...
     * @since 1.13
     */
    protected UpdateReserva(com.jtristan.reservarestaurante.entidad.reservaendpoint.model.Reserva content) {
      super(Reservaendpoint.this, "PUT", REST_PATH, content, com.jtristan.reservarestaurante.entidad.reservaendpoint.model.Reserva.class);
    }
